    ...
    return (
        <form onSubmit={onClick}>
            ...
            <div class="row Rfoam cardcolor">
                <h2 className="CH1">Veuillez créer votre compte</h2>
                <div class="col-2">
                ...
                <div class="col-10">
                    <input type="password" onChange={onChangeHandler} value = {user.cf_password} class="form-control Rinput" placeholder="Entrer à nouveau votre password" id="cf_password"></input>
                </div>
                <div >
                    <input class="Rbutton btn btn-succes" type="submit" name = "send" value = "Valider"></input>
                </div>
